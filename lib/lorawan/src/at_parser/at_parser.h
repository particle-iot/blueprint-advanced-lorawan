...
public:
     ...
     */
    AtParserConfig& stream(LoraStream* strm);
    /**
     * Returns the stream used for communication with the DCE.
     *
     * @return Stream instance.
     */
    LoraStream* stream() const;
    /**
...
inline AtParserConfig& AtParserConfig::stream(LoraStream* strm) {
    strm_ = strm;
    return *this;
}

inline LoraStream* AtParserConfig::stream() const {
    return strm_;
}
